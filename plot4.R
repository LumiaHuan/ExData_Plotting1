...
plot(data_20070102$weekdaysTime, data_20070102$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power")
plot(data_20070102$weekdaysTime, data_20070102$Voltage, xlab = "datatime", ylab = "Voltage", type = "l")
...
plot(data_20070102$weekdaysTime, data_20070102$Global_reactive_power, type = "l",xlab = "datetime", ylab = "Global_reactive_power")
